...
+ (NSArray *)initBookmarkBGColorData {
    ...
    NSArray *dataList = @[
        @{
            ...
            @"name" : @"yellow",
            @"thumbnail_color_code" : @"#9d8567",
            @"sort" : @"1",
        },
        @{
            @"id" : [Helper getNumberByInt:2],
            @"name" : @"gold",
            @"thumbnail_color_code" : @"#ff493d",
            @"sort" : @"2",
        },
        @{
        ...
        @{
            ...
            @"name" : @"blue",
            @"thumbnail_color_code" : @"#809a4d",
            @"sort" : @"4",
        },
        @{
            @"id" : [Helper getNumberByInt:5],
            @"name" : @"white",
            @"thumbnail_color_code" : @"#ffffff",
            @"sort" : @"5",
        },
        @{
            @"id" : [Helper getNumberByInt:6],
            @"name" : @"orange",
            @"thumbnail_color_code" : @"#000000",
            @"sort" : @"6",
        },
        @{
            @"id" : [Helper getNumberByInt:7],
            @"name" : @"dodger",
            @"thumbnail_color_code" : @"#d7b78f",
            @"sort" : @"7",
        },
        @{
            @"id" : [Helper getNumberByInt:8],
            @"name" : @"pink",
            @"thumbnail_color_code" : @"#ff83c1",
            @"sort" : @"8",
        },
        @{
            @"id" : [Helper getNumberByInt:9],
            @"name" : @"forest",
            @"thumbnail_color_code" : @"#5386f1",
            @"sort" : @"9",
        },
        @{
            @"id" : [Helper getNumberByInt:10],
            @"name" : @"lime",
            @"thumbnail_color_code" : @"#35d140",
            @"sort" : @"10",
        },
        @{
            @"id" : [Helper getNumberByInt:11],
            @"name" : @"black",
            @"thumbnail_color_code" : @"#e6e6e6",
            @"sort" : @"11",
        },
        @{
            @"id" : [Helper getNumberByInt:12],
            @"name" : @"sienna",
            @"thumbnail_color_code" : @"#484848",
            @"sort" : @"12",
        },
        @{
            @"id" : [Helper getNumberByInt:13],
            @"name" : @"purplered",
            @"thumbnail_color_code" : @"#f2cfa1",
            @"sort" : @"13",
        },
        @{
            @"id" : [Helper getNumberByInt:14],
            @"name" : @"wood",
            @"thumbnail_color_code" : @"#fc9584",
            @"sort" : @"14",
        },
        @{
        ...
        @{
            ...
            @"name" : @"purple",
            @"thumbnail_color_code" : @"#4dd292",
            @"sort" : @"16",
        },
        @{
            @"id" : [Helper getNumberByInt:17],
            @"name" : @"tomato",
            @"thumbnail_color_code" : @"#A6A6A6",
            @"sort" : @"17",
        },
        @{
            @"id" : [Helper getNumberByInt:18],
            @"name" : @"grey",
            @"thumbnail_color_code" : @"#666666",
            @"sort" : @"18",
        }
    ];
