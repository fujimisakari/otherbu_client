...
NSString * const kDefaultAuthType = @"default";              // アカウント無しのType名
...
NSString * const kMenuLoginName = @"ログイン";
NSString * const kMenuLogoutName = @"ログアウト";
...
NSString * const kLoginIcon = @"loginIcon.png";
NSString * const kLogoutIcon = @"logoutIcon.png";
...
NSString * const kRightArrowIcon = @"rightArrowIcon.png";
...
NSString * const kToHelpWebViewBySegue = @"toHelpWebView";                    // 設定ページ → ヘルプ
