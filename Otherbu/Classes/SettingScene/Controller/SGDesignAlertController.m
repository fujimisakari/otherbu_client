...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info {
    ...
    if ([data writeToFile:path atomically:YES]) {
        ...
        [design updatetBackgroundPicture:kCustomImageName];
        LOG(@"Image Save OK");
        LOG(@"Image Save File: %@", design.backgroundPicture);
        // データの同期登録、保存
        [[DataManager sharedManager] updateSyncData:design DataType:SAVE_DESIGN Action:@"update"];
